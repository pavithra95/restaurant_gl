                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('product_name')) text-danger @endif">
                                ...
                                <input type="text" name="product_name" class="form-control" value="{{$item->product_name}}" required="required">
                                @if($errors->has('name'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('type')) text-danger @endif">
                                ...
                                <select class="form-control select2 category_id" id="category_id" name="category_id">
                                  ...
                                  <option @if ($item->category_id == $cat->id) selected="" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('actual_price')) text-danger @endif">
                                ...
                                <input type="number" name="actual_price" class="form-control" value="{{$item->actual_price}}" required="required">
                                @if($errors->has('name'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('unit')) text-danger @endif">
                                ...
                                <input type="text" name="unit" class="form-control" value="{{$item->unit}}" required="required">
                                @if($errors->has('unit'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('preparation_time')) text-danger @endif">
                                ...
                                <input type="time" name="preparation_time" class="form-control" value="{{$item->preparation_time}}" required="required">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('discount')) text-danger @endif">
                                ...
                                <input type="number" name="discount" class="form-control" value="{{$item->discount}}" required="required">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('available_qty')) text-danger @endif">
                                ...
                                <input type="number" name="available_qty" class="form-control" value="{{$item->available_qty}}" required="required">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('minimum_qty')) text-danger @endif">
                                ...
                                <input type="number" name="minimum_qty" class="form-control" value="{{$item->minimum_qty}}" required="required">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('final_price')) text-danger @endif">
                                ...
                                <input type="number" name="final_price" class="form-control" value="{{$item->final_price}}" required="required">
                        ...
                        <a class="btn btn-danger col-md-2 ml-2 btn-sm" href="/products">Cancel </a>
                </form>
