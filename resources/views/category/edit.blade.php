            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h4 class="m-0 text-dark col-md-6 float-left">Edit Category</h4>
                ...
                <form action="/category/{{$item->id}}" method="POST" role="form" class="col-md-12" autocomplete="off">
                    {{ csrf_field() }}
                    {{method_field('PUT')}}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group @if($errors->has('name')) text-danger @endif">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{$item->category_name}}" required="required">
                                    @if($errors->has('name'))
