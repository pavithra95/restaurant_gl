...
$("#sparklineLine").sparkline(supplierName, {type: 'line', width: '150', height: '50', fillColor: '', lineColor: 'rgb(247, 126, 185)'});
$("#sparklineArea").sparkline(customerName, {type: 'line', width: '150', height: '50', fillColor: 'rgba(126, 229, 229, .2)', lineColor: 'rgb(126, 229, 229)'});
$("#sparklineBar").sparkline(productName, {type: 'bar', width: '150', height: '50', barColor: 'rgb(247, 126, 185)'});
